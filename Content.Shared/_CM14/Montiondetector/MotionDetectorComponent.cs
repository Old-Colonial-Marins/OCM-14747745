...
public sealed partial class MotionDetectorComponent : Component
{
    ...
    [DataField, AutoNetworkedField]
    public SoundSpecifier? ScanSound = new SoundPathSpecifier("/Audio/_CM/Effects/motion_detector.ogg");

    [DataField, AutoNetworkedField]
    public SoundSpecifier? ScanEmptySound = new SoundPathSpecifier("/Audio/_CM/Effects/motion_detector_none.ogg");

    [DataField, AutoNetworkedField]
    public SoundSpecifier? ToggleSound = new SoundPathSpecifier("/Audio/_CM/Effects/click.ogg");
