...
Содержимое, добавленное в этот репозиторий после коммита 40bc3537053889a74c5ebffad2e63cd3211f47ad, распространяется по лицензии [LICENSE](./LICENSE.TXT), если не указано иное.
